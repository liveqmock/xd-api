...
public class Item implements Serializable{
    ...
    private String destinationJson1;//[{"id":1001,"name":"澳洲"},{"id":1002,"name":"非洲"},{"id":1003,"name":"非洲"}]

    private String destinationJson2;//[{"id":1001,"name":"澳洲","children":[{"id":100101,"name":"悉尼"},{"id":100102,"name":"墨尔本"}],
    //{"id":1002,"name":"亚洲","children":[{"id":100201,"name":"北京"},{"id":100202,"name":"深圳"}]}]

    private String subjectJson1;// [{"id":1001,"name":"声"},{"id":1002,"name":"心"},{"id":1003,"name":"智"}]

    private String subjectJson2;//[{"id":1001,"name":"声","children":[{"id":100101,"name":"少女风格"},{"id":100102,"name":"少妇风格"}]},{}]
	...
	public String getDestinationJson2() {
		return destinationJson2;
	}

	public void setDestinationJson2(String destinationJson2) {
		this.destinationJson2 = destinationJson2;
	}

	public String getSubjectJson1() {
		return subjectJson1;
	}

	public void setSubjectJson1(String subjectJson1) {
		this.subjectJson1 = subjectJson1;
	}

	public String getSubjectJson2() {
		return subjectJson2;
	}

	public void setSubjectJson2(String subjectJson2) {
		this.subjectJson2 = subjectJson2;
	}
